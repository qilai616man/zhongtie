 ...
 */
public class DbDownloadOpenHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "GDownloader";
    public static final int DATABASE_VERSION = 2;

    public DbDownloadOpenHelper(Context context) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        stringBufferVideoDownload
                ...
                .append(DbDownloadExt.COLUMN_DOWNLOAD_FILENAME).append(" string").append(",")
