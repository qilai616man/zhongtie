...
public class DbDownloadExt {
    ...
    public static final String COLUMN_DOWNLOAD_FILENAME = "filename";
    ...
    public static class Helper {
        ...
        private Helper(Context context) {
            mDb = new DbDownloadOpenHelper(context).getWritableDatabase();
        }
        ...
        public String insertOrUpdate(final DbDownloadExt dbDownloadExt) {
            Ln.d("Insert Or update:" + dbDownloadExt.toString());
            ContentValues contentValues = new ContentValues();
            contentValues.put(COLUMN_DOWNLOAD_URL, dbDownloadExt.url);
            if(dbDownloadExt.filename != null){
                contentValues.put(COLUMN_DOWNLOAD_FILENAME, dbDownloadExt.filename);
            }
            ...
            if(queryDownloadExt(dbDownloadExt.url) != null){
        ...
        public String updateFilename(final String url, final String filename) {
            ContentValues contentValues = new ContentValues();
            contentValues.put(COLUMN_DOWNLOAD_FILENAME, filename);
            mDb.update(TABLE_VIDEO_DOWNLOAD, contentValues, COLUMN_DOWNLOAD_URL + " = ?", new String[]{url});
            return url;
        }
        ...
        private DbDownloadExt cursorToDb(Cursor cursor) {
            ...
            dbDownloadExt.filename = cursor.getString(cursor.getColumnIndex(COLUMN_DOWNLOAD_FILENAME));
