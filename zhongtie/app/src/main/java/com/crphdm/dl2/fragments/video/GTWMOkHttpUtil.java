...
public class GTWMOkHttpUtil {
    public final static int READ_TIMEOUT = 100;
    public final static int CONNECT_TIMEOUT = 60;
    public final static int WRITE_TIMEOUT = 60;
    public static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    private static final byte[] LOCKER = new byte[0];
    private static GTWMOkHttpUtil mInstance;
    private OkHttpClient mOkHttpClient;

    private GTWMOkHttpUtil() {
     ...
     * @return
     */
    public static GTWMOkHttpUtil getInstance() {
        if (mInstance == null) {
            synchronized (LOCKER) {
                if (mInstance == null) {
                    mInstance = new GTWMOkHttpUtil();
                }
            }
        }
        return mInstance;
    ...
    public String getSysn( final String url) throws Exception {
