...
public class ApprovalPickDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_pick_detail);
    ...
    private void initMembers() {
        ...
        mAdapter = new PickDetailAdapter(this);
...
//                            Toast.makeText(ApprovalPickDetailActivity.this, throwable.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }, new Action0() {
                        @Override
                        public void call() {
    ...
    private void refreshData() {
        if (mMiningMenuDetail != null) {
            ...
            mPressPrice.setText("￥" + mMiningMenuDetail.getAllPrice());
            mTime.setText(format.format(mMiningMenuDetail.getMiningDate() * 1000));
            submitPeople.setText(mMiningMenuDetail.getSubmitPeople());
            mPrice.setText("￥" + mMiningMenuDetail.getPreferentialPrice());
            if(mMiningMenuDetail.getAnnotation().equals("") || mMiningMenuDetail.getAnnotation().equals("null")){
