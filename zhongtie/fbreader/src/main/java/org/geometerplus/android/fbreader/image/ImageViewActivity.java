...
import com.ereader.zip.MainActivity;
...
//		uri = intent.getData();
//		if(ZLFileImage.SCHEME.equals(uri.getScheme())){
//			image = ZLFileImage.byUrlPath(uri.getPath());
//			if(image == null){
//				finish();
//			}
//			try {
...
//			final ZLTextRegion openImgRegion = ZLTextView.findRegion(x, y,
