...
final class TextSearchPopup extends ButtonsPopupPanel {
	...
	public void createControlPanel(FBReader activity, RelativeLayout root) {
		...
		addButton(ActionCode.FIND_PREVIOUS, false, R.drawable.icon_search_previous);
		addTextView("上一个",0);
		addButton(ActionCode.CLEAR_FIND_RESULTS, true, R.drawable.icon_search_close);
		addTextView("下一个",1);
		addButton(ActionCode.FIND_NEXT, false, R.drawable.icon_search_next);
	}
}
