 ...
 */
public class PgBookForLibraryDetail {
    ...
    public static PgBookForLibraryDetail getPgByNet(NetBookForLibraryDetailData net){
        PgBookForLibraryDetail pg = new PgBookForLibraryDetail();
